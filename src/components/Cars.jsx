export const Cars = () => {
    return (
        <div>
            <div>
                <img className="mb-1" src="./src/assets/images/Opel-Mokka.webp" alt="opel mokka auto"></img>
            ...
            <div>
                <img className="mb-1" src="./src/assets/images/Opel-Mokka.webp" alt="tesla auto"></img>
