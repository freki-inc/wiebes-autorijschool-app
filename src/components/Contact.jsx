        ...
        <div id='contact' className="contact-section">
            ...
            <div className="contact-form">
                <form className="form wd-100" action="https://formsubmit.co/email@email.com" method="POST"> {/* Moet nog worden gemaakt */}
                    ...
                    <input className="input" type="email" id="email" name="email" placeholder="Hier uw e-mailadres invullen..." required maxLength="60"/>  
                    ...
                    <div className="verzenden display-flex-row">
                        <input type="hidden" name="_next" value="https://freki-inc.github.io/wiebes-autorijschool-app/dankjewel.html"/>
